...
4. 某些网站会依旧提示让你开vip又或者付费, 但是粘贴试试, 有些是可以成功的

<!-- 
## 一些网站记录
### 无法使用的网站
- http://www.wodocx.com/  文档类网站, 使用图片显示 img
### 提示, 但是能复制成功的
- http://www.jianbiaoku.com/ 建标库: 复制提示开通VIP, 但是已经复制成功
- www.51dongshi.com 提示付费复制, 但是已经复制成功

### 其他未解决的
- https://www.dydata.io/datastore/detail/1996453535188914176/  无法加载, 一直转圈圈
- https://www.lovehtbooks.com/  注册账号后, 登录提示账号或密码错误
 -->

## 更新历史
 > v4.4.8 2022-12-13
  - 增加: 默认规则里增加了一些网站 ("www.daodoc.com","www.wcqjyw.com","www.szxx.com.cn")
 > v4.4.7 2022-11-24
  - 增加: 增加了一些网站
  - 排除: 排除了一些网站, 解决了知乎的登录问题
 > v4.4.6 2021-06-09
  - 增加: www.bimiacg.net
 > v4.4.5 2021-03-19
  - 增加: www.uta-net.com
